...
extension ExampleViewController: ExampleViewDelegate {
  ...
  internal func basicNotificationCellSelected(at index: Int) {
    ...
    case 0:
      ...
      let banner = NotificationBanner(
        title: "Basic Success Notification",
    ...
    case 1:
      ...
      let banner = NotificationBanner(
        title: "Basic Danger Notification",
        subtitle: "Extremely Customizable!",
        style: .danger)
      banner.delegate = self
    ...
    case 3:
      ...
      let banner = NotificationBanner(
        title: "Basic Warning Notification",
        subtitle: "Extremely Customizable!",
        style: .warning)
      banner.delegate = self
  ...
  internal func basicNotificationCellWithSideViewsSelected(at index: Int) {
    ...
    case 0:
      ...
      let banner = NotificationBanner(
        title: "Success Notification", subtitle: "This notification has a left view!", leftView: leftView,
        style: .success)
      banner.delegate = self
    ...
    case 1:
      ...
      let banner = NotificationBanner(
        title: "Danger Notification", subtitle: "This notification has a right view!", rightView: rightView,
        style: .danger)
      banner.delegate = self
      banner.show(queuePosition: selectedQueuePosition(), bannerPosition: selectedBannerPosition())
    case 2:
      ...
      let banner = NotificationBanner(
        title: "Info Notification", subtitle: "This notification has two side views!", leftView: leftView,
        rightView: rightView, style: .info)
      banner.delegate = self
      banner.show(queuePosition: selectedQueuePosition(), bannerPosition: selectedBannerPosition())
    default:
      return
  ...
  internal func basicGrowingNotificationCellSelected(at index: Int) {
    ...
    case 0:
      ...
      let banner = GrowingNotificationBanner(
        ...
        leftView: leftView, style: .success)
      banner.delegate = self
      banner.show(queuePosition: selectedQueuePosition(), bannerPosition: selectedBannerPosition())
    default:
      let leftView = UIImageView(image: #imageLiteral(resourceName: "danger"))
      let banner = GrowingNotificationBanner(
        ...
        subtitle:
          "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
        leftView: leftView, style: .danger, sideViewSize: 48)
      banner.delegate = self
      banner.show(queuePosition: selectedQueuePosition(), bannerPosition: selectedBannerPosition())
    }
  }
  ...
  internal func basicFloatingNotificationCellSelected(at index: Int) {
    ...
    case 0:
      let banner = FloatingNotificationBanner(
        ...
        subtitle:
          "This type of banner floats and has the capability of growing to an infinite amount of lines. This one also has a shadow.",
        style: .success)
    ...
    case 1:
      let banner = FloatingNotificationBanner(
        ...
        subtitle:
          "This type of banner floats and has the capability of growing to an infinite amount of lines.",
        style: .danger)
      banner.delegate = self
      banner.show(
        queuePosition: selectedQueuePosition(),
  ...
  internal func basicStatusBarNotificationCellSelected(at index: Int) {
    ...
    case 4:
      ...
      let banner = StatusBarNotificationBanner(
        title:
          "Warning Status Bar Notification Warning Status Bar Notification Displayed Under/Over the Navigation/Tab Bar",
        style: .warning,
        colors: CustomBannerColors())
      banner.delegate = self
      banner.show(
    ...
    if indexPath.section == 0 {
      ...
      case 0:
        return (
          ...
          "This type of banner can float and can have its cornerRadius property adjusted"
        )
      case 1:
        return (
          "Danger Notification",
  ...
  internal func showAlertWithCallback(
    title: String,
    message: String,
  ...
  internal func showAlertWithCallbackOkAction(
    title: String, message: String, buttonText: String = "OK", callback: @escaping () -> Void
  ) {
    let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
    let okAction = UIAlertAction(title: buttonText, style: .default) { (action) in
      callback()
